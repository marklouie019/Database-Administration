          ...
          <div class="postCard my-3">
            <div class="postTop">
              <div class="post-info d-flex">
                ...
                <div class="modal fade p-0" id="deleteModal" tabindex="-1" aria-labelledby="deleteModalLabel"
                ...
                <button onclick="confirmDeletion('btnDeletePost')" type="button" class="btn-delete ms-auto"
                  id="btnDeletePost">
